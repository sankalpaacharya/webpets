...
const modPurple: GifAnimalConfig = {
    name: "mod-purple",
    ...
    actions: {
        idle: "/media/mod/purple_idle_8fps.gif",
        run: "/media/mod/purple_run_8fps.gif",
        swipe: "/media/mod/purple_swipe_8fps.gif",
        walk: "/media/mod/purple_walk_8fps.gif",
        walk_fast: "/media/mod/purple_walk_fast_8fps.gif",
        with_ball: "/media/mod/purple_with_ball_8fps.gif",
    },
