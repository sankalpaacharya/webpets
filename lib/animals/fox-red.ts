...
const foxRed: GifAnimalConfig = {
    ...
    actions: {
        idle: "/media/fox/red_idle_8fps.gif",
        lie: "/media/fox/red_lie_8fps.gif",
        run: "/media/fox/red_run_8fps.gif",
        swipe: "/media/fox/red_swipe_8fps.gif",
        walk: "/media/fox/red_walk_8fps.gif",
        walk_fast: "/media/fox/red_walk_fast_8fps.gif",
        with_ball: "/media/fox/red_with_ball_8fps.gif",
    },
